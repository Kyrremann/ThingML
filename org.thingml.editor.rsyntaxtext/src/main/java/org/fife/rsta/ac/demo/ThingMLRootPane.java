...
import org.fife.rsta.ac.demo.Actions.AboutAction;
import org.fife.rsta.ac.demo.Actions.ExitAction;
import org.fife.rsta.ac.demo.Actions.LookAndFeelAction;
import org.fife.rsta.ac.demo.Actions.NewFileAction;
import org.fife.rsta.ac.demo.Actions.OpenAction;
import org.fife.rsta.ac.demo.Actions.SaveAction;
...
public class ThingMLRootPane extends JRootPane implements HyperlinkListener,
	...
	private String file = "blink.thingml";
	private String config = "_arduino/blink.thingml";
	...
	public ThingMLRootPane(CompletionProvider provider) {
		...
		tabbedPane.addChangeListener(new ChangeListener() {
			...
			public void stateChanged(ChangeEvent event) {
				...
				// TODO: Find a way to toggle between the different tabs
				// setCurrentTextArea(configArea);
				// refreshSourceTree(configArea);
				// focusCurrentTextArea();
			}
		});

		RSyntaxTextArea rSyntaxTextArea = createAndAddTextArea(file, provider);
		setText(rSyntaxTextArea, file, SYNTAX_STYLE_THINGML);
		
		rSyntaxTextArea = createAndAddTextArea(config, provider);
		setText(rSyntaxTextArea, config, SYNTAX_STYLE_THINGML);
	...
	private RSyntaxTextArea createAndAddTextArea(String title, CompletionProvider provider) {
	...
	public void addPane(String title, RTextArea rTextArea) {
		...
		tabbedPane.add(title, rTextArea);
	}
	...
	public void setText(String resource, String style) {
		setText(getCurrentTextArea(), resource, style);
	}
	
	public void setText(RSyntaxTextArea textArea, String resource, String style) {
	...
	private void setLineAndChar(int line, int offset) {
		if (cursorLabel != null)
			cursorLabel.setText("Line: " + line + " - Char: " + offset);
	}
	...
	public ThingmlResource getThingmlResource() {
		// TODO: May need to switch the view to config before this works
		// return ((ThingMLOutlineTree) tree).getThingmlResource();
		// http://thingml.org
		...
		// TODO: Saved file goes here
		URI xmiuri = URI.createFileURI(currentFilePath);
		// URI.createFileURI("/home/kyrremann/workspace/ThingML/org.thingml.samples/src/main/thingml/samples/_arduino/blink.thingml");
		...
		// ThingmlResource resource = new
		// ThingmlResource(URI.createURI("/home/kyrremann/workspace/ThingML/org.thingml.samples/src/main/thingml/samples/_arduino/blink.thingml"));
		// ResourceSetImpl resourceSetImpl = new ResourceSetImpl();
		// resourceSetImpl.getResources().add(resource);
		//
		// InputStream inputStream = new
		// ByteArrayInputStream(configArea.getText().getBytes());
		// try {
	...
	public void compileAndRunArduino() {
		...
		// System.out.println("Imports: " + model.getImports());
	...
	public int addTextArea(String title, RSyntaxTextArea rSyntaxTextArea, boolean background) {
	...
	public void openFile(File file) {
		...
		RSyntaxTextArea rSyntaxTextArea = createAndAddTextArea(file.getName(), null);

		try {
			// BufferedReader r = new BufferedReader(new FileReader(selectedFile));
			// getCurrentTextArea().read(r, null);
			// rSyntaxTextArea.read(r, null);
		    ...
		    // TODO: Can't scroll a window!
	        // System.out.println(fileContents.toString());
			// setText(rSyntaxTextArea, fileContents.toString(), SYNTAX_STYLE_THINGML);
